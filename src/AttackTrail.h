...
struct AttackTrail
{
	...
	AttackTrail(RE::NiNode* a_node, RE::TESObjectCELL* a_cell, std::optional<TrailOverride> a_trailOverride = std::nullopt, std::optional<TrailTransformOverride> a_transformOverride = std::nullopt);
